% Shared TikZ scaffold for publication figures.
%
...
\definecolor{figred}{HTML}{D55E00}
\definecolor{figpurple}{HTML}{CC79A7}
...
\tikzset{
  ...
  ours/.style={block, draw=figblue, fill=figblue!7, line width=0.7pt},
  ...
  backflow/.style={->, draw=figorange, dashed},
