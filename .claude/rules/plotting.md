---
paths: "**/*.py"
description: Matplotlib plotting conventions
---
...
- Labels on the plot are harder to read than you think. There should never be smaller font on the plot anywhere than 18.
